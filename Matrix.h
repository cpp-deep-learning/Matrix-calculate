...
calculate(S_Matrix* a, S_Matrix* b)
{
    ...
    case operate: {
        ...
        rlt = clCreateBuffer(g0->context,
            ...
            g0->cl_err);
        set = clCreateBuffer(
            g0->context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, sizeof(char), &option, g0->cl_err);
...
Matrix calculate(const Matrix& A = *new Matrix(0, 0), const Matrix& B = *new Matrix(0, 0), char choice = -1, char opt = -1, float target = 0)
{
    ...
    case 48: {
        ...
        *g0.clerr = g0.cmdqueue.enqueueNDRangeKernel(kernel, cl::NullRange, cl::NDRange(A.size<size_t>()), cl::NDRange(1), nullptr, nullptr);
    ...
    case 49: {
        ...
        *g0.clerr = g0.cmdqueue.enqueueNDRangeKernel(kernel, cl::NullRange, cl::NDRange(A.info<size_t>(0), B.info<size_t>(1)), cl::NDRange(1, B.info<size_t>(1)), nullptr, nullptr);
        check(*g0.clerr, "kernel execute");
    ...
    case 50: {
        unsigned long info[2] = { A.info<unsigned long>(0), A.info<unsigned long>(1) };
        ...
        *g0.clerr = g0.cmdqueue.enqueueNDRangeKernel(kernel, cl::NullRange, cl::NDRange(A.info<size_t>(0), A.info<size_t>(1)), cl::NDRange(1, 1), nullptr, nullptr);
        check(*g0.clerr, "kernel execute");
